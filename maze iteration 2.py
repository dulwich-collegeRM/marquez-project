...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.rect = self.image.get_rect()
        self.rect.x = random.randint(0,19) * 40
        ...
        if len(next_block_top) != 0:    
            ...
            if random_top == 0:
                ...
                if isinstance(maze_array[top_x][top_y], Block) == True: #!= Floor(LIGHTGRAY, top_x * 40, top_y * 40):
                    ...
                    floor_graph[path_array[top_x -1][top_y]].append(path_array[top_x][top_y])
                    floor_graph[path_array[top_x][top_y]].append(path_array[top_x -1][top_y])
            ...
            if random_top == 1:
                ...
                if isinstance(maze_array[top_x][top_y], Block) == True: #!= Floor(LIGHTGRAY, top_x * 40, top_y * 40):
                    ...
                    floor_graph[path_array[top_x][top_y - 1]].append(path_array[top_x][top_y])
                    floor_graph[path_array[top_x][top_y]].append(path_array[top_x][top_y - 1])
        ...
        if len(next_block_leftside) != 0:
            ...
            if random_leftside == 0:
                ...
                if isinstance(maze_array[leftside_x][leftside_y], Block) == True: # != Floor(LIGHTGRAY, leftside_x * 40, leftside_y * 40):
                    ...
                    floor_graph[path_array[leftside_x][leftside_y + 1]].append(path_array[leftside_x][leftside_y])
                    floor_graph[path_array[leftside_x][leftside_y]].append(path_array[leftside_x][leftside_y + 1])
            ...
            if random_leftside == 1:
                ...
                if isinstance(maze_array[leftside_x][leftside_y], Block) == True: # != Floor(LIGHTGRAY, leftside_x * 40, leftside_y * 40):
                    ...
                    floor_graph[path_array[leftside_x -1][leftside_y]].append(path_array[leftside_x][leftside_y])
                    floor_graph[path_array[leftside_x][leftside_y]].append(path_array[leftside_x -1][leftside_y])
        ...
        if len(next_block_rightside) != 0:    
            ...
            if random_rightside == 0:
                ...
                if isinstance(maze_array[rightside_x][rightside_y], Block) == True: # != Floor(LIGHTGRAY, rightside_x * 40, rightside_y * 40):
                    ...
                    floor_graph[path_array[rightside_x][rightside_y + 1]].append(path_array[rightside_x][rightside_y])
                    floor_graph[path_array[rightside_x][rightside_y]].append(path_array[rightside_x][rightside_y + 1])
            ...
            if random_rightside == 1:
                ...
                if isinstance(maze_array[rightside_x][rightside_y], Block) == True: # != Floor(LIGHTGRAY, rightside_x * 40, rightside_y * 40):
                    ...
                    floor_graph[path_array[rightside_x + 1][rightside_y]].append(path_array[rightside_x][rightside_y])
                    floor_graph[path_array[rightside_x][rightside_y]].append(path_array[rightside_x + 1][rightside_y])
        ...
        if len(next_block_bottom) != 0:
            ...
            if random_bottom == 1:
                ...
                if isinstance(maze_array[bottom_x][bottom_y], Block) == True: # != Floor(LIGHTGRAY, bottom_x * 40, bottom_y * 40):
                    ...
                    floor_graph[path_array[bottom_x][bottom_y + 1]].append(path_array[bottom_x][bottom_y])
                    floor_graph[path_array[bottom_x][bottom_y]].append(path_array[bottom_x][bottom_y + 1])
            ...
            if random_bottom == 2:
                ...
                if isinstance(maze_array[bottom_x][bottom_y], Block) == True: # != Floor(LIGHTGRAY, bottom_x * 40, bottom_y * 40):
                    ...
                    floor_graph[path_array[bottom_x - 1][bottom_y]].append(path_array[bottom_x][bottom_y])
                    floor_graph[path_array[bottom_x][bottom_y]].append(path_array[bottom_x - 1][bottom_y])
