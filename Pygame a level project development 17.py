...
##            if random_top == 0:
##                top_y -= 1
##                if maze_array[top_x][top_y] != Floor(LIGHTGRAY, top_x * 40, top_y * 40):
...
##                    top_connect = True
        ...
        if leftside_connect == False:
            ...
            if random_leftside == 0:
                leftside_y -= 1
                if maze_array[leftside_x][leftside_y] != Floor(LIGHTGRAY, leftside_x * 40, leftside_y * 40):
        ...
        if rightside_connect == False:
            ...
            if random_rightside == 0:
                rightside_y -= 1
                if maze_array[rightside_x][rightside_y] != Floor(LIGHTGRAY, rightside_x * 40, rightside_y * 40):
...
##                    rightside_connect = True
        ...
        if bottom_connect == False:
            ...
            if random_bottom == 0:
                bottom_y -= 1
                if maze_array[bottom_x][bottom_y] != Floor(LIGHTGRAY, bottom_x * 40, bottom_y * 40):
