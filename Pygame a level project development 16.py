...
##                                         
        ...
        if leftside_connect == False:
            ...
            random_leftside = random.randomchoice(next_block_leftside)
...
##                floor_sprite_list.add(maze_array[leftside_x][leftside_y])
        ...
        if rightside_connect == False:
            ...
            random_rightside = random.randomchoice(next_block_rightside)
...
##                floor_sprite_list.add(maze_array[rightside_x][rightside_y])
        ...
        if bottom_connect == False:
            ...
            random_bottom = random.randomchoice(next_block_bottom)
            if random_bottom == 0:
                bottom_y -= 1
...
##                floor_sprite_list.add(maze_array[bottom_x][bottom_y])
        ...
        if lefside_connect == True and top_connect == True and rightside_connect == True and bottom_connect == True:
            reach_floor = True
